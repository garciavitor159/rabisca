...
form.addEventListener("submit", function (e) {
  ...
  if (!validarCampo(nome) || !validarValorObrigatorio(valNome, 30)) {
    alternarModalMsg(
      true,
      "Erro: O nome de usuário é obrigatório e deve conter até 30 caracteres."
    );
  ...
  if (!validarCampo(senha) || !senhaRegExp.test(valSenha)) {
    alternarModalMsg(
      true,
